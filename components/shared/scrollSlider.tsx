...
const ScrollHtml = React.forwardRef(
  (
    ...
    React.useEffect(() => {
      ...
      root.render(
        <div ref={mergeRefs([ref, group])} style={{ ...style }} {...props}>
      ...
      state.fixed.appendChild(container);
      return () => {
        root.unmount();
        state.fixed.removeChild(container);
      };
    }, [state, children, style, props]);
...
export const Scroll = React.forwardRef(
  ({ html, ...props }: { html?: boolean; children?: React.ReactNode }, ref) => {
